...
template <class T>
my::Stack<T>::Stack() : m_size{ 0 }, m_cap{ 0 }, m_ptr{ nullptr }
{
}
...
my::Stack<T>::Stack(const std::initializer_list<T>& init_list)
    : m_size{ 0 }, m_cap{ init_list.size() }, m_ptr{ new T[m_cap] }
{
...
template <class T>
my::Stack<T>::Stack(const Stack& other) : m_size{ other.m_size }, m_cap{ other.m_cap }, m_ptr{ new T[m_cap] }
{
...
template <class T>
my::Stack<T>::Stack(Stack&& other) noexcept : m_size{ other.m_size }, m_cap{ other.m_cap }, m_ptr{ other.m_ptr }
{
    other.m_size = 0;
    other.m_cap = 0;
    other.m_ptr = nullptr;
